...
//    printBMP(width, height, frame_buffer);
    ...
    copyFrame(frame_buffer, frame_copy, width, height); //TODO
    implementation_driver_reference(sensor_values, sensor_values_count, frame_copy, width, height, false); //TODO
    copyFrame(frame_buffer, frame_copy, width, height);
    implementation_driver(sensor_values, sensor_values_count, frame_copy, width, height, false);
    verifiedAllFrames(); //TODO
